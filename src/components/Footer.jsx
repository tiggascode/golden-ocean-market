  ...
  return (
    <footer className="bg-premium-onyx-900 border-t border-premium-gold-500/20 relative">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="mt-12 pt-8 border-t border-premium-gold-500/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-premium-pearl-400 text-sm">
              © 2024 Krivetka.am. All rights reserved. Luxury seafood experience.
            </p>
            <div className="flex items-center gap-6">
              <span className="text-premium-pearl-400 text-sm">Premium Quality</span>
              <div className="w-2 h-2 bg-premium-gold-400 rounded-full"></div>
              <span className="text-premium-pearl-400 text-sm">Sustainable Sourcing</span>
              <div className="w-2 h-2 bg-premium-emerald-400 rounded-full"></div>
              <span className="text-premium-pearl-400 text-sm">Expert Curation</span>
            </div>
          </div>
        </div>
      </div>
